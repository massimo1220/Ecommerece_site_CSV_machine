...
let pa_id_for_list = 1;                 /// number of list
...
function main_machine_f2(cate_id, rowObject) {
    ...
    product["name(it-it)"] = rowObject["Artikelname"];
    product["meta_title(it-it)"] = rowObject["Artikelname"];
    product["categories"] = cate_id;
    product["ean"] = rowObject["EAN"];
    product["image_name"] = "https://www.magazzinimax.it/image/ridimensionate/" + rowObject["EAN"] + ".jpg";
    product["quantity"] = rowObject["Menge"];
    product["model"] = rowObject["Artikelnummer"];
    product["manufacturer"] = rowObject["Hersteller"];
    product["price"] = rowObject["Preis"];
    const d = new Date();
    let str_date = d.getFullYear() + "-" + (d.getMonth() + 1) + "-" + d.getDate() + " " + d.getHours() + ":" + d.getMinutes() + ":" + d.getSeconds();
    product["date_added"] = str_date;
    product["date_modified"] = str_date;
    product["date_available"] = d.getFullYear() + "-" + (d.getMonth() + 1) + "-" + d.getDate();
    product["description(it-it)"] = rowObject["Beschreibung"];
